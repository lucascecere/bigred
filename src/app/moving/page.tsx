  ...
  return (
    <main>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(getServiceSchema('moving')) }}
      />
      <script
        type="application/ld+json"
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(getFAQSchema(movingServicePage.faq)) }}
      />
      ...
      <section className="bg-[var(--brand-black)] py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          ...
          >
            {movingServicePage.h1}
          </h1>
          <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-8">
            {movingServicePage.heroSubhead}
          </p>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          <div className="space-y-12">
            {movingServicePage.sections.map((section, index) => (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {movingLocationPages.map((loc) => (
              ...
              >
                ...
                <span className="text-[var(--brand-steel)] text-sm">Moving Company</span>
      ...
      <section className="bg-white py-16">
        <div className="max-w-3xl mx-auto px-5 sm:px-6">
          ...
          <div className="space-y-4">
            {movingServicePage.faq.map((item, index) => (
              <details
                key={index}
