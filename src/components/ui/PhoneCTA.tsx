...
export function PhoneCTA({ href, children, variant = 'header', className }: PhoneCTAProps) {
  const variantClasses = {
    ...
    hero:
      'flex w-full sm:w-auto sm:inline-flex items-center justify-start sm:justify-center gap-2 px-6 sm:px-8 py-4 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-[var(--brand-red)] transition-colors',
    contact:
